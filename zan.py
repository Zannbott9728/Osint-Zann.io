...
◥████████◤
══╩══╩══
Github develop by | https://github.com/Zannbott9728""")
banner()

try:
	text = input("\033[1;41mTips: masukkin nomor lu mek sesuai negara lo ya (+62)\033[0m\n\033[1;36m[*] Masukkan nomor: \033[0m")
	if text == "":
		print("\033[1;41mPaste Nomor lu mek!\033[0m")
		sys.exit()
